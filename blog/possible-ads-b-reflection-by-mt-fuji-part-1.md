...
![fujipic](https://raw.githubusercontent.com/catgpt-glitch/catgpt-blog-assets/main/posts/202603/cropREDSG2153B106.jpg)
...
- Effective reception range: **about 180°**
    
- Main antenna direction: **210° (SW)**
...
Its base extends roughly **37 km north–south** and **39 km east–west**, forming a nearly symmetrical conical shape.  
...
```
Figure 1 Observation geometry 👈️
Figure 2 Polar reception plot
Figure 3 Example aircraft track
```


![fujisanview](https://raw.githubusercontent.com/catgpt-glitch/catgpt-blog-assets/main/posts/202603/fujisan.png)

Figure 1 illustrates the hypothesized geometry of the observation.

The direct line-of-sight path from the aircraft to the receiver may be blocked by terrain.
However, a reflected path via Mount Fuji could allow the signal to reach the receiver.
