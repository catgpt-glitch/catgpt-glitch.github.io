...
This suggests that long-range reception itself is not unusual.
...
Some aircraft appear to be lost once, then received again farther west.

This raises two possible explanations:

Reflection from a mountain surface, including Mt. Fuji itself

Diffraction, where the signal bends around a ridge or peak and propagates into the shadowed region behind the obstacle
...
At this stage, I cannot determine which mechanism is dominant.
However, both mountain reflection and terrain diffraction remain plausible candidates.
